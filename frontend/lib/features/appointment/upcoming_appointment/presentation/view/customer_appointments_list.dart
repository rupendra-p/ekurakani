...
class CustomerAppointmentsList extends StatefulWidget {
  const CustomerAppointmentsList({Key? key}) : super(key: key);

  @override
  State<CustomerAppointmentsList> createState() =>
      _CustomerAppointmentsListState();
}

class _CustomerAppointmentsListState extends State<CustomerAppointmentsList> {
  ...
  @override
  void initState() {
    BlocProvider.of<UpcomingCustomerAppointmentBloc>(context)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: BlocBuilder<UpcomingCustomerAppointmentBloc,
            UpcomingAppointmentState>(
          builder: (context, state) {
            if (state is GetCustomerUpcomingAppointmentLoadedState) {
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      appointmentData.counsellor!.user!.details != null
                          ? appointmentData
                                      .counsellor!.user!.details!.full_name !=
                                  null
                              ? appointmentData
                                  .counsellor!.user!.details!.full_name!
                              : "N/A"
                    ...
                    Text(
                      appointmentData.counsellor!.user!.details != null
                          ? appointmentData.counsellor!.user!.details!
                                  ...
                                  null
                              ? appointmentData
                                  .counsellor!.user!.details!.contact_number!
                              : "N/A"
                          : "N/A",
                    ),
                  ],
