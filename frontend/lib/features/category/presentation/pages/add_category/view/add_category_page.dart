...
class _AddCategoryScreenState extends State<AddCategoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // appBar(
      //     noBackButton: true, navTitle: "Category Name", backNavigate: () {}),
      body: BlocConsumer<CategoryBloc, CategoryState>(
        listener: (context, state) {
          if (state is AddcategoryLoadedState) {
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content: Text('Category has been added sucess!'),
              ...
              child: Column(
                ...
                children: [
                  ...
                  ActionButton(
                      ...
                      borderRadius: 10,
                      isLoading:
                          state is AddCategoryLoadingState ? true : false,
                      text: Text(
                        "Add",
                      ...
                      onPressed: () {
                        BlocProvider.of<CategoryBloc>(context).add(
                          AddCategoryEvent(
                            addCategoryEntity: AddCategoryEntity(
